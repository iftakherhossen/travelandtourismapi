"""
Django settings for travelandtourism project.
...
SECRET_KEY = 'django-insecure-f^3+=)nk=98q3!rcryf^kp0cc-ym!m$z*&==5$knln(sgw&7eu'
...
ROOT_URLCONF = 'travelandtourism.urls'
...
WSGI_APPLICATION = 'travelandtourism.wsgi.application'
